...
try {
    ...
    if (!isset($_SESSION['usuario']) || $_SESSION['usuario'] !== 'admin') {
        header("Location: ponto/admin/index.php");
        exit();
    }
...
<body>
    <div class="container">
        ...
        <a href="/ponto/admin/pedidos_da_equipe.php">Pedidos de Alteração</a><br>
        <a href="/ponto/admin/gerar_relatorio.php">Gerar Relatório</a><br>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if(!empty($ponto['foto'])): ?>
                                ...
                                <a href="#" onclick="abrirModal('/ponto/foto/<?= htmlspecialchars($ponto['foto']) ?>', '<?= htmlspecialchars($ponto['usuario']) ?>', '<?= date("d/m/Y - H:i:s", strtotime($ponto['data_hora'])) ?>'); return false;">Ver Foto</a>
                            <?php else: ?>
                                Sem foto
                            <?php endif; ?>
                        </td>
