...
try {
    ...
    if (isset($_GET['action']) && isset($_GET['id'])) {
        ...
        if ($pedido && $pedido['status'] == 'Pendente') {
            ...
            header("Location: /ponto/admin/pedidos_da_equipe.php");
            exit();
        }
    }
          ...
          <tr>
            ...
            <td>
              <?php if($pedido['status'] == 'Pendente'): ?>
                <a href="/ponto/admin/pedidos_da_equipe.php?action=aceitar&id=<?= $pedido['id'] ?>" onclick="return confirm('Aceitar este pedido?')">Aceitar</a>
                <br>
                <a href="/ponto/admin/pedidos_da_equipe.php?action=rejeitar&id=<?= $pedido['id'] ?>" onclick="return confirm('Rejeitar este pedido?')">Rejeitar</a>
              <?php else: ?>
                -
              <?php endif; ?>
            </td>
